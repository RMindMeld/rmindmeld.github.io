...
description: "A small example of a dialogue about the infamous Han Solo debate AI-generated, and AI rendered."
date: "2024-11-19"
categories: Claude, OpenAI, tts, Star Wars
...
There are limits, of course. I have only 6 voices to choose from. And have not yet tested the limits of the audio file length. Still, I got a good working prototype that does the job. I can share the code if you are interested.
...
<div class="audio-player">
   <audio controls>
   <source src="https://github.com/RMindMeld/podcast_asset/blob/main/who-shot-first.mp3" type="audio/mpeg">
